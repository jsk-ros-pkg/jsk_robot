...
xterm -sb -rightbar -sl 99999 +s -title "RVIZ" -e "export PS1=pr2admin; source ~/.bashrc; ROS_MASTER_URI=http://${PR2_NAME}:11311 rosrun rviz rviz -d $(rospack find jsk_pr2_startup)/config/jsk_startup.vcg" &
