...
class OdometryTransformer(object):
    ...
    def __init__(self):
        ...
        self._frame_id_base_link_virtual = str(rospy.get_param('~frame_id_base_link_virtual','base_link_virtual'))
    ...
    def cb_odometry(self,msg):
        ...
        pos_base_odombased = pos_t265_odombased + quat_t265_odombased.rotate( self._pos_base_t265based )
        ...
        pos_dot_base_basebased = self._quat_t265_basebased.rotate(
                                    pos_dot_t265_t265based + np.cross( omega_t265_t265based, self._pos_base_t265based )
                                    )
        omega_base_basebased = self._quat_t265_basebased.rotate( omega_t265_t265based )
