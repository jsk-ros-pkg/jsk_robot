display: Go To 73B2
platform: spot
launch: jsk_spot_apps/go_to_73b2.xml
interface: jsk_spot_apps/go_to_73b2.interface
plugins:
  - name: insta_360_video_recorder_plugin
    type: app_recorder/audio_video_recorder_plugin
    launch_args:
      video_path: /tmp
      video_title: go_back_to_73b2_insta_360_video.avi
  ...
  - name: rosbag_recorder_plugin
    ...
    launch_args:
      rosbag_path: /tmp
      rosbag_title: go_back_to_73b2.bag
      compress: true
      rosbag_topic_names:
        - /rosout
        - /tf
  ...
  - name: result_recorder_plugin
    ...
    plugin_args:
      result_path: /tmp
      result_title: go_back_to_73b2.yaml
  - name: gdrive_uploader_plugin
    type: app_uploader/gdrive_uploader_plugin
    plugin_args:
      upload_file_paths:
        - /tmp/go_back_to_73b2.yaml
        - /tmp/go_back_to_73b2.bag
        - /tmp/go_back_to_73b2_insta_360_video.avi
      upload_file_titles:
        - go_back_to_73b2.yaml
        - go_back_to_73b2.bag
        - go_back_to_73b2_insta_360_video.avi
      upload_parents_path: spot_go_back_to_73b2
